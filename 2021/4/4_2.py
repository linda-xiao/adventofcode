...
# List of boards without bingo yet (currently all boards)
notYetBingo = bingoBoards

# For each drawn number
for number in drawnNumbers:

    # Update list of all boards that have not gotten bingo yet
    bingoBoards = notYetBingo

    # Empty list of boards without bingo yet
    notYetBingo = []
    ...
    for i, board in enumerate(bingoBoards):
        ...
        # If not bingo, append the board to list of boards without bingo yet
            ...
            notYetBingo.append(bingoBoards[i])
